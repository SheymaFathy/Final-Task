...
<div class="container-xxl bg-white p-0">
    ...
    $det = $_GET['det'];
    $details = $con->query("SELECT * FROM meal WHERE id = '$det'");
    $row = $details->fetch_array(MYSQLI_ASSOC);
    ?>
    <div class="det_item">
        <a href="#">
        <img src="<?php echo $row['img'] ?>"style=" border-radius: 10px !important; width: 600px; height:350px !important">
        </a>
        </div>
        <div class="details">
        <div class="desc"><?php echo $row['meal_name']?></div>
        <div class="desc"><?php echo $row['det']?></div>

            <div class="price">$ <?php echo $row['price']?></div>
            <input onclick="order1()" class="order-btn" type="submit" value="ORDER">
